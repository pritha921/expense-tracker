    ...
    return (
        <TableContainer component={Paper} style={{ maxWidth: '600px', margin: '20px auto' }}>
            <Table aria-label="caption table">
                <caption style={{ fontSize: '15px', fontWeight: 'normal', textAlign: 'right', marginBottom: '10px' }}>
                ...
                <TableHead>
                    <TableRow style={{ backgroundColor: '#f0f0f0' }}>
                        ...
                        <TableCell align="right" style={{ fontSize: '18px', fontWeight: 'bold' }}>Actions</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
